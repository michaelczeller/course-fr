...
<!-- Steps:    -->
<!-- - create Google forms poll and publish it    -->
<!-- - link it to a Google Sheet -->
<!--     + rename the columns to unique single words -->
<!--     + add at least 10 extra columns to the sheet -->
<!--     + publish to the web (file > share > publish to web)  -->
<!--         - just the sheet (not the whole workbook) AND *as a CSV* -->
<!--         - in 'Published content & settings' make it 'Entire Document' and tick the option to 'automatically republish...' -->
<!--     + copy the link and use it broken up as in the first code chunk -->
<!-- - create link and QR code for survey -->
<!--     + in the Google form, click the 'Published' settings at top right > 'copy responder link' and tick 'shorten URL' -->
...
<br>Take the survey at **<https://forms.gle/epUVVCkebH3sQcW76>**
:::
::::
...
- A seminar---a big one, but still a seminar
    + **[very important to read for informed discussion]{style="color:red;"}**
        * answer specific questions, clarify concepts
        * evaluate research, connect to related empirical material
    + losing my hearing + big room + quiet speaker = ☹    
        * so [please speak up]{style="color:red;"}
    + lengthier discussions &rarr; may not cover all slides
    + I will learn your names---but I need your help: [participate in discussions]{style="color:red;"}

- If you have a comment related to the discussion, say it! It's much better than telling me after class
...
- most of the readings are research journal articles
    ...
    + consider complementing with a general reader (examples listed in [Syllabus](https://michaelzeller.de/course-fr/syllabus/))

## Presentation (*Referat*)

- short (max. 20 mins.) group (3-4 people) presentation on a method
- groups and date today, topics due to me by [Week 4 (15 May)]{style="color:red;"}
...
- A couple rules: (1) **no national-level election data** (if you want to study a party/parties, consider EU-level or regional-level or local-level); (2) **no drawing any data from or citing Statista or other data curation services**.
...
## a flowchart created using Mermaid:
...
* [But better to look at the new, shiny, developing, purpose-built website:]{style="color:red;"}: <https://michaelzeller.de/course-fr/>
...
# Presentation groups {background-color="#2c844c"}

:::: {.columns}
:::{.column width="65%"}

[If presenting required for your course of study, form groups of 3-4. <br> [Tell me your group and top 3 preferred dates]{style="color:red;"}:]{style="font-size:60px;"}

<https://forms.gle/6oRRsp9gaeNtGTSv6>

:::

::: {.column width="35%" .right}

![](slide_files/01/groups_survey.png)
...
## Ideological components (maximum definition)
...
[I will discuss these terms in next week's slides]{style="color:red;"} 
