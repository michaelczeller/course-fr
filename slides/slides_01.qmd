---
title: "Class 1"
subtitle: "Intro to Course"
author: "[Michael C. Zeller](https://michaelzeller.de)"
format: 
  rladies-revealjs:
    footer: ""
incremental: false
...
<!-- [MZeller](https://michaelzeller.de/) for [Quarto Presentations](https://quarto.org/docs/presentations/revealjs/index.html). Code available on [GitHub](https://github.com/beatrizmilz/quarto-rladies-theme). -->
